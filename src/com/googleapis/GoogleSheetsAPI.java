...
public class GoogleSheetsAPI {
    ...
    public static GoogleSheetsAPI googleSheetsSingleton=null;
    ...
    public static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = GoogleSheetsAPI.class.getClassLoader().getResourceAsStream(CREDENTIALS_FILE_PATH);
    ...
    public static GoogleSheetsAPI getSingleton() {
    	if(googleSheetsSingleton == null)
    		googleSheetsSingleton = new GoogleSheetsAPI();
